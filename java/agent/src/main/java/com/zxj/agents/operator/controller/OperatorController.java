...
import com.zxj.agents.operator.model.OperateLogModel;
...
public class OperatorController {
    ...
    public Object login(@RequestParam("account")String account, @RequestParam("password")String password){
        ResultModel result = this.operatorService.login(account,password);
        OperateLogModel logModel = new OperateLogModel(account+" 登录: "+ result.isSuccess(),account);
