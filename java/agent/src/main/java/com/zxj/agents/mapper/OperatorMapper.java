...
public interface OperatorMapper {
    ...
    @Insert("insert into operators" +
            "        (id,role_id,password,AK,SK,phone,addr,login_utc,creater)" +
            "        values" +
            "        (#{model.id},#{model.roleId},#{model.password},#{model.AK},#{model.SK},#{model.phone},#{model.addr},#{model.loginUtc},#{model.creater}" +
